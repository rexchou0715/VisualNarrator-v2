...
def process_dataset(model: str, rounds: int) -> None:
    """
    ...
    for dataset in DATASETS:
        ...
        report_path = os.path.join(out_dir, f"association_report_{ds}.xlsx")
...
if __name__ == "__main__":
    for MODEL, ROUNDS in MODELS.items():
        print(f"▶ Running association-matching for {MODEL} ({ROUNDS} rounds)…")
